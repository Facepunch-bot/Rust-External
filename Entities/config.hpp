...
struct Settings{
	...
	bool setadmin, no_animations, doublejump, omni_sprint, spiderman, water, node_esp, sulfur_node, stone_node, metal_node, hackable_crate, patrol_heli, hemp, food_esp, high_tier_crate, low_tier_crate, airdrop, cargo_esp, tool_cupboard, dropped_esp, stash_esp, heli_esp, corpse_esp;
	float gravity_multiplier = 0.975f, day_time = 12;
	int max_dist = 300, max_dist_ore = 300, max_dist_vehicle = 300, max_dist_collectable = 300, max_dist_high_crate = 300, max_dist_low_crate = 300, max_dist_corpse = 300, max_dist_airdrop = 300, max_dist_tool_cupboard = 300, max_dist_dropped_items = 300, max_dist_stash = 300, max_dist_hackable = 300;
	bool skeleton_esp = true, fov_changer_on_key, DrawPlayers = true, distance_esp = true, name_esp = true, held_weapon = true, hotbar_esp, filled_box_esp = true, box_esp = true, head_esp = true, flag_esp, oldbox_esp = true, sleeper, scientist, recoil_control_system, standalone_recoil_control_system, health_esp = true, team_esp = true, fast_swim, speedhack;
